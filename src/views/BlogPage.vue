<template>
  ...
  <!-- modifications start here -->
          ...
          <div class="w-full px-5">
            ...
            >
              <img
                :src= blog.image
                alt="image"
                class="h-full w-full justify-self-center object-cover object-center"
              />
              <div
                class="absolute top-0 left-0 z-10 flex h-full w-full items-end bg-gradient-to-t from-slate-900 to-transparent"
              >
            ...
            <div class="-mx-4 flex flex-wrap">
                  ...
                  <div class="-mx-4 mb-12 flex flex-wrap items-center">
                    <div class="w-full px-4 md:w-1/2">
                      ...
                      >
                        <a
                          href="javascript:void(0)"
                          class="mr-2 mb-2 block rounded bg-blue-600 bg-opacity-5 py-2 px-5 text-xs font-semibold text-blue-600 hover:bg-opacity-100 hover:text-white md:mr-4 lg:mr-2 xl:mr-4"
                        >
                          Design
                        </a>
                        <a
                        ...
                        <a
                          href="javascript:void(0)"
                          class="mb-2 block rounded bg-blue-600  bg-opacity-5 py-2 px-5 text-xs font-semibold text-blue-600 hover:bg-opacity-100 hover:text-white"
                        >
                          Info
                        </a>
                      </div>
              ...
              <div class="w-full px-4 lg:w-4/12">
                <div>
                  <div
                    class="wow fadeInUp relative mb-12 overflow-hidden rounded bg-blue-600 py-[60px] px-11 text-center lg:px-8"
                    data-wow-delay=".1s
                    "
                  >
                  ...
                  <div class="-mx-4 mb-8 flex flex-wrap">
                    <div class="w-full px-4">
                      ...
                      <span
                        class="mb-10 inline-block h-[2px] w-20 bg-blue-600"
                      ></span>
                    </div>
        ...
        <div class="-mx-4 flex flex-wrap">
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div class="wow fadeInUp group mb-10" data-wow-delay=".1s">
              ...
              <div>
                <span
                  class="mb-5 inline-block rounded bg-blue-600 py-1 px-4 text-center text-xs font-semibold leading-loose text-white"
                >
                  Dec 22, 2023
                </span>
                <h3>
          ...
          <div class="w-full related-card  px-4 md:w-1/2 lg:w-1/3">
            <div class="wow fadeInUp group mb-10 " data-wow-delay=".2s">
              ...
              <div>
                ...
                <h3>
                  <a
                    href="blog-details.html"
                    class="mb-4 inline-block text-xl font-semibold text-dark hover:text-blue-600 sm:text-2xl lg:text-xl xl:text-2xl"
                  >
    ...
    <a
      href="javascript:void(0)"
      @click="scrollToTop()"
      class="back-to-top fixed bottom-8 right-8 left-auto z-[999] flex  h-10 w-10 items-center justify-center rounded-md bg-blue-600  text-white shadow-md transition duration-300 ease-in-out hover:bg-dark"
    >
      <span
