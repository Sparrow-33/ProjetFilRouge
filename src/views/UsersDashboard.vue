                ...
                <table class="min-w-full leading-normal z-10 ">
                    <thead class=" ">
                        <tr class="bg-slate-700 text-white ">
                            ...
                            <th scope="col" class="px-5 py-3   border-b border-gray-200   text-left text-sm uppercase font-normal">
                                Role
                            </th>
                            <th scope="col" class="px-5 py-3   border-b border-gray-200   text-left text-sm uppercase font-normal">
                                Created at
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 text-sm">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <a href="#" class="block relative">
                                            <img alt="profil" src="@/assets/trianglify-lowres.png" class="mx-auto object-cover rounded-full h-10 w-10 "/>
                                        </a>
                                    </div>
                                    <div class="ml-3">
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-400 text-sm">
                                <span class="relative inline-block px-3 py-1 font-semibold  leading-tight">
                                    <span aria-hidden="true" class="absolute inset-0 bg-emerald-200 opacity-50 rounded-full">
                                    </span>
                                    <span class="relative">
                                        active
                                    </span>
