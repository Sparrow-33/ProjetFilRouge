    ...
    <div class="container mx-auto my-5 p-5">
      <div class="md:flex no-wrap md:-mx-2">
        ...
        <div class="w-full md:w-9/12 mx-2 h-64">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-14 gap-x-16 border-5">
            <div class="overflow-hidden shadow-lg rounded-lg h-90 w-52 md:w-80 cursor-pointer m-auto">
                <a href="#" class="w-full block h-full">
                    <img alt="blog photo" src="../assets/blog-01.jpg" class="max-h-40 w-full object-cover"/>
