<template>
  ...
  <NavBar/>
    ...
    <section class="pt-12 pb-10 lg:pt-[50px] lg:pb-20">
      <div class="container ">
          ...
          <div class="w-full px-10">    
            <div class="-mx-4 flex flex-wrap ">
              <div class="w-full px-4 lg:w-8/12">
                <div>
                  <h2
                    class="wow fadeInUp text-5xl mb-6  font-bold leading-snug text-dark sm:text-3xl sm:leading-snug md:text-4xl md:leading-snug"
                  ...
                  <h3
                    class="wow fadeInUp mb-8 text-2xl font-thin border-b-2 pb-2 text-dark sm:text-[26px]"
                    data-wow-delay=".1s"
                  >
                    Qu'est-ce que le HTML ?
                  </h3>
                  <p
                    class="mb-10 text-base leading-relaxed text-body-color"
                    
                  >
                <ul>
                    <li>- HTML signifie Hyper Text Markup Language</li>
                    <li>- HTML est le langage de balisage standard pour la création de pages Web</li>
                    <li>- HTML décrit la structure d'une page Web</li>
                    <li>- HTML se compose d'une série d'éléments</li>
                    <li>- Les éléments HTML indiquent au navigateur comment afficher le contenu</li>
                    <li>- Les éléments HTML étiquettent des éléments de contenu tels que "ceci est un titre", "ceci est un paragraphe", "ceci est un lien", etc.</li>
                </ul>
                  </p>
                 
                  <h3
                    class="wow fadeInUp mb-8 text-2xl font-thin border-b-2 pb-2 text-dark sm:text-[26px] mt-8"
                    data-wow-delay=".1s"
                  >
              ...
              <div class="w-full px-4 lg:w-4/12">
                <div>
                  ...
                  <div class="-mx-4 mb-8 flex flex-wrap border-l-2">
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      <div
                        ...
                        "
                      >                      
                        <div class="w-full border-y-2 pb-2">
                          <h4>
                            <a
                              href="javascript:void(0)"
