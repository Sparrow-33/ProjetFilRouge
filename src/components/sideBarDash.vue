<template>
  <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
                ...
                <nav class="mt-6">
                    <div>
                        <router-link to="/DashBoard" class="w-full font-thin uppercase text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r  border-r-4 border-blue-500 focus:dark:from-gray-700 focus:dark:to-gray-800 focus:border-r-4 focus:border-blue-500" >
                        ...
                        <router-link to="#" class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start  hover:text-blue-500 focus:dark:from-gray-700 focus:dark:to-gray-800 focus:border-r-4 focus:border-blue-500">
                            <span class="text-left">
                        ...
                        <router-link to="/UsersDashboard" class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="#">
                            <span class="text-left">
